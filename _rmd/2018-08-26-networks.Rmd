...
This takes some getting use to, to create the query you want.  We suggest consulting the manual for more options. We give a few other examples below.  

We can also do network-sciency things as well as the standard `dplyr` fare.  
